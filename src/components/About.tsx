        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-6 font-sans">
              ...
              with leading tea producers across East Africa. Mr. Tefera further contributes his expertise in sales management and
            ...
            <p className="text-lg text-muted-foreground mb-6 font-sans">
              Quality assurance is paramount to our operations. Habtam Limited holds a valid Rainforest Alliance
              endorsement (Endorsement Code: RALI23-023619, valid through March 2029), confirming that our operations
              meet the Rainforest Alliance Sustainable Agriculture Standard 2020. Our tea trading and warehousing
              activities are conducted under Identity Preserved and Segregation traceability levels, ensuring full
              chain-of-custody integrity for every shipment. Our quality control team conducts thorough inspections
              at multiple stages—from leaf selection and processing to packaging and shipment—guaranteeing that only
              the finest tea reaches our clients.
            </p>
